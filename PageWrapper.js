                    ...
                    <nav className="navbar navbar-default navbar-custom">
                        ...
                        <div className="collapse navbar-collapse flex-parent" id="bs-example-navbar-collapse-1">
                                ...
                                <li className="dropdown first">
                                    ...
                                    <ul className="dropdown-menu level1">
                                        <li className="dropdown">
                                            <a className="dropdown-toggle" data-toggle="dropdown" >Movie grid<i className="ion-ios-arrow-forward"></i></a>
                            ...
                            <ul className="nav navbar-nav flex-child-menu menu-right">
                                ...
                                <li><a>Help</a></li>
                                <li className="loginLink"><a>LOG In</a></li>
                                <li className="btn signupLink"><a>sign up</a></li>
                            </ul>
                        </div>
                    </nav>
                ...
                <div className="container">
                    <div className="flex-parent-ft">
                        ...
                        <div className="flex-child-ft item5">
                            ...
                            <a className="btn">Subscribe now <i className="ion-ios-arrow-forward"></i></a>
                        </div>
                    </div>
                </div>
